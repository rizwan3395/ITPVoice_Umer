...
// }
  ...
  loadSettings() {
    String? realm = SharedPreferencesMethod.getString(StorageKeys.REALM);
    Devices device = SharedPreferencesMethod.getDeviceData()!;
    String? username = device.sipUsername;
    String? password = device.sipPassword;
    ...
    print(realm);
    settings.webSocketSettings.extraHeaders = {
      "Proxy-Authorization": "Digest realm=$realm"
      ,"X-Auth-Token": "Bearer $password",
    ...
    settings.uri = "sip:$username@$realm";
    ...
    settings.registrarServer = "sip:$realm";
    print("CONNECTED 222");
