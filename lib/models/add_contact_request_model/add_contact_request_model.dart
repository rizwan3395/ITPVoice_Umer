...
class AddContactRequestModel {
  ...
  @override
  String toString() {
    return 'AddContactRequestModel(name: $name,lastname: $lastName, numbers: $numbers, number: $number, labelNumber: $labelNumber, emails: $emails, email: $email, labelEmail: $labelEmail, notes: $notes)';
  }
