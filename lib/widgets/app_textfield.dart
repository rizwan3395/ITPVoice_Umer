...
class AppTextField extends StatelessWidget {
  ...
  Color? dark = Color.fromARGB(255, 0, 35, 64);
  Color? light = Color.fromARGB(255, 232, 240, 254);
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: hint,
        hintStyle: TextStyle(color: cc.minitxt.value, fontSize: 14.sp),
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: Color.fromARGB(255,232, 240, 254), width: 1), // Change the color and width for visibility
        ...
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(color: Color.fromARGB(255,232, 240, 254), width: 0.5), // Change the color and width for visibility
          borderRadius: BorderRadius.all(
            Radius.circular(
              borderRadius!,
            ),
        ...
        border: OutlineInputBorder(
          borderSide: BorderSide(color: Color.fromARGB(255,232, 240, 254), width: 0.5), // Default border style
          borderRadius: BorderRadius.all(
            Radius.circular(
              borderRadius!,
            ),
